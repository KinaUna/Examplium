...
namespace Examplium.IdentityServer.Pages.ExternalLogin
{
    [AllowAnonymous]
    [SecurityHeaders]
    public class CallbackModel : PageModel
    {
        ...
        {
            var externalResulScheme = externalResult.Properties?.Items["scheme"];
            if ( externalResulScheme != null)
            {
                // capture the idp used to login, so the session knows where the user came from
                localClaims.Add(new Claim(JwtClaimTypes.IdentityProvider, externalResulScheme));
            }
